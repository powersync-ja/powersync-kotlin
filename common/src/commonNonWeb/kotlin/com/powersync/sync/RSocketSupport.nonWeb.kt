...
internal actual typealias PowerSyncRSocketError = RSocketError

internal actual fun PowerSyncRSocketError.indicatesInvalidCredentials(): Boolean = this is RSocketError.Setup.Rejected
